...
public class NewHighscoreScene extends CCScene implements ButtonDelegate {
    ...
    public NewHighscoreScene() {
        ...
        logo = new CCSprite(Assets.FINALEND);
        logo.setPosition(
                screenWidth() / 2.0f,
                screenHeight() - 100
        );
    ...
    public void onEnter() {
        ...
        Sound.playEffect(R.raw.finalend);
    }
